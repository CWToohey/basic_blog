...
Join me at noon on June 20th at the Town Lake dock, as I curl up on a sun-warmed bench and listen to a presentation by Ima Amoeba, Our Town Biologist. Ima will be discussing the health of Our Town Lake, the threats to our water quality, and the actions we can take to preserve our waters.
Bring a lunch, some folding chairs, fishing poles, and any extra sardines you may have hidden away in the pantry. If it rains, there’ll be plenty of puddles for lapping and low benches for cover. Human residents, please remember to bring a beverage and an umbrella.",
...
And if for you, a car trip means riding shotgun with your head out the window and the wind in your face? You just keep on keepin' on. But ease up on the barking. Especially you chihuahuas.",
                'created_at' => "2017-03-25 15:24:39",
                'updated_at' => "2018-03-25 19:27:05",
                'path' => "images/samples/skyline.JPG"
            ],
            [
                'title' => "A Bird-Brained Solution To The Affordable Housing Crisis?",
                'isPost' => 1,
...
To hear residents' ideas, opinions, and concerns, I’ll be hosting a meet-and-greet-and-pet potluck at the Town Library on April 1 at 8:00 p.m. Please contact Head Librarian Rita Book if you plan on attending. Last-minute drop-ins are also welcome.
Stop by. Bring a treat. Don’t forget the tuna fish and catnip.",
                'created_at' => "2017-03-25 15:26:19",
            ...
            [
                ...
                'isPost' => 0,
                'content' => "Charles “Charlie” Le Chat is a well-loved and respected member of Our Town. Most residents know Charlie because of the outstanding work he has done promoting tourism in our community. Vacationers from across the state and around the country travel to Our Town just to meet Charlie and have their picture taken with him (photo with bowtie for a small fee).
